...
class ScoreBoardState extends State<ScoreBoard> {
  ...
  */
  ...
  void gameOver(Team _winner, bool lessSets){
    setState(() {
      isGameOver = true;
      if(_team2.score[currentSet.toString()] == setMaximum) {
  ...
  void fetchTeams (){
    ...
    setState(() {
      ...
      root.child(mirrorMatchNumber).child("CurrentSet").once().then((value) => {print(int.parse(value.value.toString()))});
          ...
          switch (actions[actionNumber.toString()]){
            ...
            case 6: {
              ...
              if(online){
                ...
                root.child(matchNumber).child("CurrentSet").child(currentSet.toString());
                root.child(matchNumber).child("Team1").child("Score").child(currentSet.toString()).set(_team1._score[currentSet.toString()].toString());
                root.child(matchNumber).child("Team2").child("Score").child(currentSet.toString()).set(_team2._score[currentSet.toString()].toString());
                                     ...
                                     child: ListView(
                                       children: <Widget>[
                                         ...
                                         mirrorMode ? Container() : Row(
                                           ...
                                           children: <Widget>[
                                             Container(
                                               margin: EdgeInsets.only(top: 7.5, left: 20),
                                               child: Text(
                                             ...
                                             Container(
                                               margin: EdgeInsets.only(top: 7.5, right: 20),
                                               child: Switch(
                                                 value: lastSetTo15,
                                                 onChanged: (val){
                                                   setSt(() {
                                           ...
                                           children: <Widget>[
                                             Container(
                                               ...
                                               child: TextFormField(
                                                 ...
                                                 decoration: InputDecoration(
                                                   hintText: online ? matchNumber : "Ingresa un PIN de 6 dígitos",
                                                 ),
                                                 onChanged: (val){
                                                   setState(() {
                                                     matchNumber = val;
